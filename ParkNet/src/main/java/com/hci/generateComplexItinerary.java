 ...
 */
@WebServlet("/generateComplexItinerary.do")
public class generateComplexItinerary extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 StringBuilder sb = new StringBuilder();
	        ...
	        if(executed) {
	        	String filePath = "destination_options.txt";
	...
	private boolean executePython() {
		try {
            ...
            String scriptPath = "/Users/ramunagalla/Desktop/MSCS/Assignments/hci/parknet/ParkNet/src/main/java/com/hci/advanced_itinerary.py";
